...
import { Machine, WorkLog, EntryType } from '../../../types';
...
interface ShiftControlProps {
  ...
  setSlotMachineIds: (ids: Record<number, string>) => void;
  machines: Machine[];
...
const ShiftControl: React.FC<ShiftControlProps> = ({
  perms,
  activeShifts,
  overtimeAlerts,
  isAbsentToday,
...
export default memo(ShiftControl);
