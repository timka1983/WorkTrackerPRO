    ...
    return (
      <div className="flex items-center justify-between ml-1 mb-1">
        ...
        <input 
          ...
          className="w-3 h-3 rounded border-slate-300 text-blue-600 dark:text-blue-400 focus:ring-blue-500 cursor-pointer"
    ...
    <div className="fixed inset-0 z-[200] bg-slate-900/70 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] w-full max-w-md shadow-2xl dark:shadow-slate-900/40 border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col max-h-[90vh]">
         <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/50 shrink-0">
            <h3 className="font-black text-slate-900 dark:text-slate-50 uppercase tracking-tight">Редактировать сотрудника</h3>
            <button onClick={() => setEditingEmployee(null)} className="text-slate-400 hover:text-slate-900 dark:text-slate-50 text-2xl font-light">&times;</button>
         </div>
           ...
           <form onSubmit={saveEmployeeEdit} className="p-8 space-y-4">
              <div className="space-y-1">
                 ...
                 <input 
                   ...
                   className="w-full border-2 border-slate-100 dark:border-slate-800 rounded-2xl px-4 py-3 text-sm font-bold outline-none focus:border-blue-500 bg-white dark:bg-slate-900 dark:text-slate-100 shadow-sm dark:shadow-none" 
                 />
              </div>
              <div className="space-y-1">
                 ...
                 <p className="text-[10px] text-slate-400 ml-1 italic">
                   * Используется для праздничного оформления кабинета и уведомлений руководства.
                 </p>
              </div>
              <div className="space-y-1">
              ...
              <div className="grid grid-cols-2 gap-4">
                 <div className="space-y-1">
                    ...
                    <input 
                      ...
                      className="w-full border-2 border-slate-100 dark:border-slate-800 rounded-2xl px-4 py-3 text-sm font-mono font-black text-blue-600 dark:text-blue-400 bg-white dark:bg-slate-900 shadow-sm dark:shadow-none" 
                    />
                 </div>
                 <div className="flex flex-col justify-end">
                    <div className={`flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-800 rounded-2xl border-2 border-slate-100 dark:border-slate-700 h-[52px] ${!planLimits.features.photoCapture ? 'opacity-50' : ''}`}>
                       <input 
                         ...
                         id="edit-req-photo" 
                       />
                       <label htmlFor="edit-req-photo" className="text-[9px] font-black text-slate-600 dark:text-slate-300 uppercase cursor-pointer">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1">
                         ...
                         <input 
                           ...
                           className={`w-full bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-sm font-bold outline-none focus:border-blue-500 dark:text-slate-100 shadow-sm dark:shadow-none ${!editingEmployee.payroll?.overrides?.rate ? 'opacity-50 cursor-not-allowed bg-slate-50 dark:bg-slate-800' : ''}`}
                         />
                      </div>
                      <div className="space-y-1">
                         ...
                         <input 
                           ...
                           className={`w-full bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-sm font-bold outline-none focus:border-blue-500 dark:text-slate-100 shadow-sm dark:shadow-none ${!editingEmployee.payroll?.overrides?.overtimeMultiplier ? 'opacity-50 cursor-not-allowed bg-slate-50 dark:bg-slate-800' : ''}`}
                         />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1">
                         ...
                         <input 
                           ...
                           className={`w-full bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-sm font-bold outline-none focus:border-blue-500 dark:text-slate-100 shadow-sm dark:shadow-none ${!editingEmployee.payroll?.overrides?.nightShiftBonus ? 'opacity-50 cursor-not-allowed bg-slate-50 dark:bg-slate-800' : ''}`}
                         />
                      </div>
                      <div className="space-y-1">
                         ...
                         <input 
                           ...
                           className={`w-full bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-sm font-bold outline-none focus:border-blue-500 dark:text-slate-100 shadow-sm dark:shadow-none ${!editingEmployee.payroll?.overrides?.sickLeaveRate ? 'opacity-50 cursor-not-allowed bg-slate-50 dark:bg-slate-800' : ''}`}
                         />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2 pt-2 border-t border-slate-200 dark:border-slate-700">
                      <div className="flex items-center justify-between">
                        ...
                        {availableMachines.length > 0 && editingEmployee.payroll?.overrides?.machineRates && (
                          <select 
                            className="text-[10px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg px-2 py-1 outline-none focus:border-blue-500 font-bold text-slate-600 dark:text-slate-300 ml-2 shadow-sm dark:shadow-none"
                            value=""
                            onChange={e => {
                            ...
                            return (
                              <div key={m.id} className="flex items-center gap-2">
                                <div className="flex-1 min-w-0">
                                  <span className="text-xs font-bold text-slate-700 dark:text-slate-200 truncate block">{m.name}</span>
                                </div>
                                <input 
                                  type="number" 
                                  placeholder="Ставка"
                                  ...
                                  className={`w-24 bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-700 rounded-xl px-2 py-1 text-xs font-bold outline-none focus:border-blue-500 dark:text-slate-100 shadow-sm dark:shadow-none ${!editingEmployee.payroll?.overrides?.machineRates ? 'opacity-50 cursor-not-allowed bg-slate-50 dark:bg-slate-800' : ''}`}
                                />
                                <button
                                  type="button"
                                  disabled={!editingEmployee.payroll?.overrides?.machineRates}
              ...
              <div className="bg-amber-50 dark:bg-amber-900/10 p-4 rounded-2xl border border-amber-100 dark:border-amber-900/30 space-y-3">
                 <p className="text-[9px] font-black text-amber-700 dark:text-amber-500 uppercase tracking-widest text-center">Безопасность и доступ</p>
                 
                 <div className="space-y-1">
                    <label className="text-[9px] font-black text-amber-700 dark:text-amber-500 uppercase ml-1">Telegram Chat ID</label>
                    <div className="flex gap-2">
                      <input 
                        ...
                        className="w-full border-2 border-amber-200 dark:border-amber-900/50 rounded-xl px-3 py-2 text-sm font-bold outline-none focus:border-amber-500 bg-white dark:bg-slate-900 text-amber-900 dark:text-amber-100 shadow-sm dark:shadow-none" 
                      />
                    ...
                    <div className="flex justify-between items-center mt-1">
                      <p className="text-[9px] text-amber-600 dark:text-amber-400/70">Для личных уведомлений</p>
                    ...
                    {telegramSettings?.enabled && (
                      <div className="mt-3 pt-3 border-t border-amber-200/50 dark:border-amber-900/30 space-y-2">
                        <div className="flex items-center justify-between mb-1">
                          <p className="text-[8px] font-black text-amber-700 dark:text-amber-500 uppercase tracking-tighter">Типы уведомлений для сотрудника:</p>
                          {!editingEmployee.telegramChatId && (
                            <span className="text-[7px] font-bold text-amber-500 dark:text-amber-400 uppercase bg-amber-100 dark:bg-amber-900/50 px-1.5 py-0.5 rounded">Требуется ID</span>
                          )}
                        </div>
                            ...
                            <label key={type.id} className="flex items-center gap-2 cursor-pointer group">
                              <div className="relative flex items-center">
                                <input 
                                  ...
                                  className="w-4 h-4 rounded border-amber-300 dark:border-amber-700 text-amber-600 dark:text-amber-400 focus:ring-amber-500 cursor-pointer bg-white dark:bg-slate-900"
                                />
                              </div>
                              <span className="text-[10px] font-bold text-amber-800 dark:text-amber-500 group-hover:text-amber-900 dark:group-hover:text-amber-400 transition-colors uppercase tracking-tight">{type.label}</span>
                            </label>
                          ))}
                        </div>
                      </div>
                 ...
                 <button 
                   ...
                   className={`w-full py-3 rounded-xl font-black uppercase text-[10px] tracking-widest transition-all border-2 ${editingEmployee.forcePinChange ? 'bg-amber-600 text-white border-amber-600' : 'bg-white dark:bg-slate-900 text-amber-600 dark:text-amber-400 border-amber-200 dark:border-amber-900/50 hover:bg-amber-100 dark:hover:bg-amber-900/30'}`}
                 >
                 ...
                 <button 
                   ...
                   className="w-full py-3 bg-white dark:bg-slate-900 text-amber-600 dark:text-amber-400 rounded-xl font-black uppercase text-[10px] tracking-widest transition-all border-2 border-amber-200 dark:border-amber-900/50 hover:bg-amber-100 dark:hover:bg-amber-900/30"
                 >
                   Сбросить привязку устройства
                 </button>
              </div>

              <button type="submit" className="w-full py-4 bg-blue-600 text-white rounded-2xl font-black shadow-xl dark:shadow-slate-900/20 shadow-blue-100 uppercase text-xs tracking-widest mt-2">Сохранить изменения</button>
           </form>
         </div>
      </div>
    </div>
